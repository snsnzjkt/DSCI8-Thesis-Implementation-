"""
Test script for SCS-ID with subset of data
"""
...
def load_subset_data():
    ...
    # Convert to PyTorch tensors and reshape for SCS-ID model
    # SCS-ID expects input shape: [batch_size, channels=1, features, 1]
    X = torch.FloatTensor(X)
    X = X.reshape(-1, 1, X.shape[1], 1)  # Reshape to [batch, 1, features, 1]
